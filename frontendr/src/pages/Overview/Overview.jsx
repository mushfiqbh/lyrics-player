...
const Overview = () => {
  ...
  return (
    <div className="overview">
      ...
      <ul className="overview_metadata">
        <li>
      ...
      <div className="overview_nav" lang="en">
      ...
      {overview.keyterms[0].key && (
        <ul className="overview_keyterms">
          <h2>তথ্য সুচক</h2>
          <div className="keyterms_trigger">
            {overview.keyterms.map(
              (item, index) =>
                item.key && (
                  <b
